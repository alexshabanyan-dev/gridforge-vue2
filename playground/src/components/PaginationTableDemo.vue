<template>
  <section class="section">
    ...
    <p class="section__description">
      Пример использования пагинации с известным общим количеством элементов (totalElements). Можно
      выбрать размер страницы и переключаться между страницами с отображением номеров страниц.
    </p>
    <GridforgeTable
      :data="paginatedRows"
      :columns="columns"
